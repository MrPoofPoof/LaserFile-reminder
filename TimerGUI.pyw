...
def createWindow():
    ...
    y_pos = math.floor(((screenHeight - windowHeight) / 2) * 0.80) #multiply by 0.8 to make the window appear more to the top of the screen
...
#Label and Button for second window
    changeLog = createLabel(recurringWindow, "ZMIEŃ LOG LASERA \n(nie nad linią!)")
    changeLog.pack()

    timerRestartButton = createButton(recurringWindow, 'OK', 'light green', timerRestart)
